    ...
    if all_check_ids:
        checks = client.search_read(
            ...
            [
                ...
                "x_studio_totfrutaverde",
                "x_studio_totdeshidratado",
                "x_studio_totheridapartida",
                "x_studio_totcrumble",
    ...
    for rec in recepciones:
        ...
        if check_ids and check_ids[0] in checks_map:
            ...
            calidad_data = {
                ...
                "fruta_verde": qc.get("x_studio_totfrutaverde", 0) or 0,
                "deshidratado": qc.get("x_studio_totdeshidratado", 0) or 0,
                "herida_partida": qc.get("x_studio_totheridapartida", 0) or 0,
                "crumble": qc.get("x_studio_totcrumble", 0) or 0,
