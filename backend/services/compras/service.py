...
REFACTORIZADO: Helpers extraídos a módulos separados.
"""
...
from .helpers import clean_record, compute_receive_status, compute_approval_status
...
class ComprasService:
    ...
    def get_ordenes_compra(self, fecha_inicio: str, fecha_fin: str,
        ...
        receive_status_map = compute_receive_status(self.odoo, po_ids)
        ...
        for po in pos:
            ...
            approval_status = compute_approval_status(
