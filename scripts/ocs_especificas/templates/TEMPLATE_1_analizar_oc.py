...
# -*- coding: utf-8 -*-
"""
TEMPLATE: Análisis de OC con error
Personalizar las variables OC_NAME, PRECIO_CORRECTO, CANTIDAD_CORRECTA según el caso
"""
import xmlrpc.client

# ============= CONFIGURACIÓN =============
OC_NAME = 'OC12345'  # ⬅️ CAMBIAR AQUÍ
PRECIO_CORRECTO = None  # ⬅️ CAMBIAR AQUÍ (o None si no aplica)
CANTIDAD_CORRECTA = None  # ⬅️ CAMBIAR AQUÍ (o None si no aplica)
...
# Buscar por description (método 1)
...
print(f"\n💰 Capas encontradas por description: {len(valuation_layers)}\n")

# También buscar por stock_move_id si hay movimientos
if pickings:
    for picking in pickings:
        moves = models.execute_kw(db, uid, password, 'stock.move', 'search_read',
            [[['picking_id', '=', picking['id']]]],
