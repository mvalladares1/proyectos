...
# -*- coding: utf-8 -*-
"""
TEMPLATE: Corrección completa en cadena de OC
...
# ============= CONFIGURACIÓN =============
OC_NAME = 'OC12345'  # ⬅️ CAMBIAR AQUÍ

# Definir correcciones necesarias
CORRECCIONES = {
    'oc_id': None,  # Se buscará automáticamente
    'moneda_id': None,  # ⬅️ CAMBIAR si se requiere cambio de moneda (ej: 2 para USD, 45 para CLP)
    'lineas': [
        {
            'linea_id': None,  # ⬅️ CAMBIAR: ID de la línea de compra
            'precio_nuevo': None,  # ⬅️ CAMBIAR si aplica corrección de precio
            'cantidad_nueva': None,  # ⬅️ CAMBIAR si aplica corrección de cantidad
            'moves_ids': []  # ⬅️ CAMBIAR: IDs de stock.move a actualizar (obtener del análisis)
        }
    ],
    'facturas_borrador_eliminar': []  # ⬅️ CAMBIAR: IDs de facturas en borrador a eliminar
}
