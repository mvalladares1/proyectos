"""
Script para corregir quant negativo en PACK0026199
Revierte el error de asignación de lote en la transferencia interna.

Uso:
    python scripts/fix_quant_negativo_pack0026199.py
"""
...
def main():
    ...
    print("=" * 80)
    print("CORRECCIÓN DE QUANT NEGATIVO - PACK0026199")
    print("=" * 80)
    ...
    # Buscar el paquete
    print("\n2. Buscando paquete PACK0026199...")
    ...
    if not packages:
        print("   ✗ ERROR: Paquete PACK0026199 no encontrado")
        return
